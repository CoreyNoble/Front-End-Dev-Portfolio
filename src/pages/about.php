    ...
    <div id="about-me" class="section black">
      <div class="row introduction">
        ...
        <div id="icon-container" class="icon-container large-7 medium-12 small-12 columns">
          <h5 class="fadeInRight black text-center">The programs and technologies I use most&nbsp;often:</h5>
          ...
          <div class="icon fadeInRight large-3 medium-3 small-4 columns">
            <img src="http://www.corey-noble.com/assets/img/icons/git-kraken.png" alt="GitKraken Version Control"/>
          </div>
          <div class="icon fadeInRight large-3 medium-3 small-4 columns">
  ...
  <div class="section white">
    <div class="row">
      ...
      <div class="about-experience large-10 medium-9 small-12 columns">
        <h3 class="fadeInDown wow" >Web Production Specialist</h3>
        ...
        <ul>
          <li class="fadeInDown wow"><b>ExactTarget / SalesForce</b> – Creating, editing and testing email campaigns and monthy emails.  Incorperating dynamically generated content, Including; qr codes, company variables and user data. Creating and updating email templates, Sending and scheduling emails for a large subscriber base. Sending batches of emails per hour to large audiences and sending specific emails to region filtered&nbsp;users.</li>
          <li class="fadeInDown wow"><b>WordPress</b> –  Development of the re-designs of websites, updating page content, media assets and&nbsp;data.</li>
          <li class="fadeInDown wow"><b>RedDot by OpenText</b> – Creating Product items and incorperating them and their promotions throughout websites. Creating web pages and components. Updating microsites, templates and banners in 3 language&nbsp;variations.</li>
          <li class="fadeInDown wow"><b>Photoshop + Illustraitor</b> –  Used to create website graphics, for photo manipulation and photo&nbsp;optimization.</li>
          <li class="fadeInDown wow"><b>InDesign</b> – Creating training documentation &nbsp;manuals.</li>
          <li class="fadeInDown wow"><b>SiteCore</b> – Updating documentation and page content in 2 language&nbsp;variations.</li>
          <li class="fadeInDown wow"><b>Magento</b> –  Creating hundreds of products with unique identifiers that work in conjunction with an e-commerce database. Creating web pages that dynamically load products and&nbsp;content.</li>
          <li class="fadeInDown wow"><b>AEM - Adobe Experience Manager</b> –  Page development, component development, website maintenance, asset manipulation, version control and quality assurance for 12+&nbsp;languages.</li>
          <li class="fadeInDown wow"><b>Foundation + SCSS</b> – Website development using the Foundation framework. Using SCSS variables + mixins to create websites under strict branding&nbsp;guidelines.</li>
          <li class="fadeInDown wow"><b>GIT + Source Control</b> –  Using BitBucket to store project repositories and their branches, accessed via Source Tree for easy version&nbsp;control.</li>
          <li class="fadeInDown wow"><b>JIRA + Confluence</b> – Ticket tracking for website tasks and maintenance. Creating internal Wiki&nbsp;documentation.</li>
          <li class="fadeInDown wow"><b>Agile Methodology</b> –  Professional training on Agile Methodology. Creating and managing team Kanban boards, daily Scrums and frequent retrospective&nbsp;meetings. Evaluating the scope of projects, breaking them into managable tasks and tracking team&nbsp;velocity.</li>
          <li class="fadeInDown wow"><b>SEO + WCAG Guidelines</b> –  Thorough research and training on Search Engine Optimization best practices and the Web Content Accessibility&nbsp;Guidelines.</li>
        </ul>
        <b class="fadeInDown wow" >Training and Certifications:</b></p>
      ...
      <div class="about-experience large-10 medium-9 small-12 columns">
        <h3 class="fadeInDown wow" >Co-Owner, Website Developer and Graphic&nbsp;Artist</h3>
        ...
        <ul>
          <li class="fadeInDown wow"><b>WordPress + Joomla</b> – We used WordPress and Joomla as the primary means of web&nbsp;development.</li>
          <li class="fadeInDown wow"><b>Photoshop + Illustraitor</b> – Used to create the media we produced. Including: Branding, Website Compositions, Website Graphics and Print&nbsp;Graphics.</li>
          <li class="fadeInDown wow"><b>Trello</b> –  This was our way of tracking the work that was to be done, in-progress and completed. When we weren't working together, we would split up pre-defined project work in&nbsp;Trello.</li>
          <li class="fadeInDown wow"><b>Mind Mapping</b> –  We would create mind maps to map out project needs, determine the importance of tasks, and sort tasks by&nbsp;relevance.</li>
          <li class="fadeInDown wow"><b>InDesign</b> –  When creating the branding for Right Choice, aswell as any client documentation, I used In-Design to create print ready&nbsp;PDFs.</li>
        </ul>
      </div>
      <div class="about-experience large-2 medium-3 small-12 columns">
      ...
      <div class="about-experience large-10 medium-9 small-12 columns">
        <h3 class="fadeInDown wow" >3D Artist and Unity Developer</h3>
        ...
        <ul>
          <li class="fadeInDown wow"><b>Project Management</b> – The priority of each game was low development cost. Each project had to be carefully managed to ensure&nbsp;success.</li>
          <li class="fadeInDown wow"><b>Technical Skills</b> –  <i>GIT + Version Control, Unity Game Development, 3DS Max (Modelling + Animation), Photoshop (Texturing + Concept&nbsp;Art).</i></li>
        </ul>
      </div>
      ...
      <!-- EDUCATION -->
        ...
        <div class="about-experience large-10 medium-9 small-12 columns">
          <h3 class="fadeInDown wow" >3D Animation and Character&nbsp;Design</h3>
          ...
          <ul>
            <li class="fadeInDown wow"><b>Time Management</b> – Our assignments were always under very strict timelines and Time Managment was the key to passing the course. Today, I concider this the most valuable skill I&nbsp;have.</li>
            <li class="fadeInDown wow"><b>Project Management</b> – We often had multiple projects on-the-go with competing deadlines. Dedicated focus on project management was&nbsp;nessesary.</li>
            <li class="fadeInDown wow"><b>Team Collaboration</b> – We created platformer and isometric shooter games in groups ranging from 5-6 people. I learned all about the tensions that build in a team under strict deadlines and how to deal with the stress of team members that aren't getting along or performing at their&nbsp;role.</li>
            <li class="fadeInDown wow"><b>Constructive Criticism</b> – Our teacher was an industry veteran who was very critical about feedback. He was our client and if something wasn't up to spec, we had to rectify it. I learned very quickly the importance of listening and adhering to the feedback and critisisms of my&nbsp;work.</li>
            <li class="fadeInDown wow"><b>Technical Skills</b> – The Technical skills I honed in this program are: <i>Concept Art, Sculpting, Retopology + Mesh-Optimization, Upwrapping + Texturing, Rigging + Animation, Lighting + Rendering, Game&nbsp;Development</i>.</li>
          </ul>
        </div>
        <div class="about-experience large-2 medium-3 small-12 columns">
          <img class="rollIn wow" src="http://www.corey-noble.com/assets/img/icons/graduate.png" alt="Graduate"/>
        ...
        <div class="about-experience large-10 medium-9 small-12 columns">
          <h3 class="fadeInDown wow" >Multi-Media Design and&nbsp;Production</h3>
          ...
          <ul>
            <li class="fadeInDown wow"><b>Photoshop</b> – Website Production Graphics</li>
            <li class="fadeInDown wow"><b>Illustraitor</b> – Vector art for Scalable Media and&nbsp;Print</li>
            <li class="fadeInDown wow"><b>HTML, XML, CSS, JavaScript, PHP</b> – Website&nbsp;Development</li>
            <li class="fadeInDown wow"><b>In-Design</b> – Creating Print-Ready Documentation</li>
            <li class="fadeInDown wow"><b>ActionScript, Flash, Flash-Builder</b> – Web App Development</li>
            <li class="fadeInDown wow"><b>After Effects, Media Encoder</b> – Video Production, VFX, Video&nbsp;Output</li>
          </ul>
        </div>
        </div>
      </div>
