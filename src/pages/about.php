    ...
    <div class="row">
      ...
      <div class="about-experience large-10 medium-9 small-12 columns">
        ...
        <ul>
          ...
          <li class="fadeInDown wow"><u>RedDot by OpenText</u> – Creating Product items and incorperating them and their promotions throughout websites. Creating web pages and components. Updating microsites, templates and banners in 3 language variations.</li>
          ...
          <li class="fadeInDown wow"><u>Magento</u> –  Creating hundreds of products with unique identifiers that work in conjunction with an e-commerce database. Creating web pages that dynamically load products and content.</li>
