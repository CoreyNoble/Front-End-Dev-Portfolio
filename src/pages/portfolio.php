...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <div id="parallax-hero-3" class="parallax" data-stellar-background-ratio="0.4" >
      <h1 class="zoomInDown wow">Portfolio<br><hr><small>Corey Noble | 2016</small></h1>
    </div>
  ...
  <div class="section blue">
    ...
    <div id="parallax-portfolio" class="parallax hide-tablet hide-mobile" data-stellar-background-ratio="0.8" ></div>
