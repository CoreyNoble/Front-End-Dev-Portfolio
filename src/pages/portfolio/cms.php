...
<html class="no-js" lang="en">
  <head>
    ...
    <title>CMS | Portfolio | Corey Noble</title>
  ...
  <body>
    ...
    <div id="parallax-hero-3" class="parallax" data-stellar-background-ratio="0.4" >
      <h1 class="zoomInDown wow">Content Management Systems<br><hr><small>Corey Noble | 2016</small></h1>
    </div>
  ...
  <div class="section blue">
    ...
    <div id="parallax-cms-portfolio" class="parallax hide-tablet hide-mobile" data-stellar-background-ratio="0.8" ></div>
