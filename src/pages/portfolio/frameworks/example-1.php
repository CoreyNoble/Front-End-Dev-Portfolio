...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Foundation Example 1 | Corey Noble</title>
  ...
  <body>
    ...
    <div id="parallax-hero-3" class="parallax" data-stellar-background-ratio="0.4" >
      <h1 class="zoomInDown wow">Framework Example 1<br><hr><small>Corey Noble | 2016</small></h1>
    </div>
  ...
  <div class="section blue">
    ...
    <div id="parallax-framework-example-1" class="parallax hide-tablet hide-mobile" data-stellar-background-ratio="0.8" ></div>
