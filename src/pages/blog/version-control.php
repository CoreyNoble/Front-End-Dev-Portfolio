...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Version Control | Corey Noble</title>
    <link rel="icon" type="image/jpeg" href="http://www.corey-noble.com/favicon.jpg" />
    <link rel="canonical" href="http://corey-noble.com/blog/version-control" />
  ...
  <div class="section blue">
    <div class="row">
      <div class="large-12 columns">
        <h1 class="header-no-parallax fadeInDown wow">Version Control</h1>
      </div>
    </div>
  </div>
