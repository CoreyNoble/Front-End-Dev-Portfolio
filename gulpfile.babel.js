...
gulp.task('build',
gulp.series(clean, gulp.parallel(pages, php_pages, sass, javascript, images, copy, copy_javascriptTetris), styleGuide));
...
function watch() {
  gulp.watch(PATHS.assets, gulp.series(copy, copy_javascriptTetris));
  gulp.watch('src/pages/**/*.html').on('all', gulp.series(pages, browser.reload));
  gulp.watch('src/pages/**/*.php').on('all', gulp.series(php_pages, browser.reload));
  gulp.watch('src/{layouts,partials}/**/*.html').on('all', gulp.series(resetPages, pages, browser.reload));
  gulp.watch('src/assets/scss/**/*.scss').on('all', sass);
  gulp.watch('src/assets/js/**/*.js').on('all', gulp.series(javascript, copy_javascriptTetris, browser.reload));
