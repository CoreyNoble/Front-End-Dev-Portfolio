...
gulp.task('build',
gulp.series(clean, gulp.parallel(pages, php_pages, sass, javascript, images, copy)));
...
function javascript() {
  return gulp.src(PATHS.entries)
    ...
    .pipe($.if(!PRODUCTION, $.sourcemaps.write()))
    .pipe(gulp.dest(PATHS.dist + '/assets/js/javascript30'));
}
